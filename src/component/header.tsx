  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: "Conseils en Architecture de conception logicielle", href: "/services-professionnels/architecture" },
        { label: "Définition et intégration de processus de QA", href: "/services-professionnels/qa" },
        { label: "Analyse et conception d'applications logicielles", href: "/services-professionnels/applications" },
        { label: "Modélisation et automatisation de processus", href: "/services-professionnels/modelisation" },
        { label: "Gestion et Traitement documentaire", href: "/services-professionnels/documentaire" },
        { label: "Installation d'un call center", href: "/services-professionnels/call-center" },
        {
          label: "Installation d'un système de Gestion de File d'Attente",
          href: "/services-professionnels/gestion-file",
        },
